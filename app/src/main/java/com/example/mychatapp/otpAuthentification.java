...
public class otpAuthentification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otp_authentification);
        ...
        mchangenumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(otpAuthentification.this, chatActivity.class);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    Intent intent = new Intent(otpAuthentification.this, setProfile.class);
                    startActivity(intent);
                    finish();
                }
                else
